...
@section('body')
    ...
    <div class="row info-row col-md-offset-1 col-md-10">
        ...
        <ul>
            ...
            <li><a href="play/join">As well as a list of groups recruiting players in the area</a></li>
            <li><a href="play/join">Find out about organisations offering opportunities and experience for young musicians.</a></li>
            <li><a href="learn/purchase">Where to buy, rent or borrow an instrument.</a></li>
            <li><a href="learn/maintainance">Where to get an instrument repaired.</a></li>
